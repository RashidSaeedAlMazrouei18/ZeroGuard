 ...
 * This file demonstrates how to integrate Zeroguard with a web frontend
 */

// For React/Vue/Angular applications
export class ZeroguardClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new ZeroguardClient(provider, contractAddress);
